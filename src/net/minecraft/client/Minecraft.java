...
import cn.timer.ultra.Initializer;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public Minecraft(GameConfiguration gameConfig) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        theMinecraft = this;
        ...
        try {
            ...
            e.printStackTrace();
            ProtectionLoader.getLoadedClass().get("AntiLeak").getMethod("crashClient", String.class, String.class).invoke(null, "Error", "Error while loading Client!");
        }
    }
    ...
    private void startGame() throws Exception {
        ...
        frame.display("Loading please wait...");
        ...
        frame.setText("Loading Textures...");
        this.refreshResources();
        this.renderEngine = new TextureManager(this.mcResourceManager);
        this.mcResourceManager.registerReloadListener(this.renderEngine);

        frame.setText("Loading Skin...");
        ...
        frame.setText("Binding Textures...");
        ...
        frame.setText("Item Renderer");
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        this.itemRenderer = new ItemRenderer(this);
        this.mcResourceManager.registerReloadListener(this.renderItem);

        frame.setText("Entity Renderer");
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        this.mcResourceManager.registerReloadListener(this.entityRenderer);

        frame.setText("Block Renderer");
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);

        frame.setText("Render Global");
        this.renderGlobal = new RenderGlobal(this);
        this.mcResourceManager.registerReloadListener(this.renderGlobal);

        frame.setText("Effect Renderer");
        this.guiAchievement = new GuiAchievement(this);
        GlStateManager.viewport(0, 0, this.displayWidth, this.displayHeight);
        this.effectRenderer = new EffectRenderer(this.theWorld, this.renderEngine);

        frame.setText("Post startup:");
        ...
        frame.setText("Ultra Client StartUp...");
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("client/logox16.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("client/logox32.png"));
            ...
            if (!(this.currentScreen instanceof GuiControls) || ((GuiControls) this.currentScreen).time <= getSystemTime() - 20L) {
                if (Keyboard.getEventKeyState()) {
                    if (i == this.gameSettings.keyBindStreamStartStop.getKeyCode()) {
                        ...
                        if (isFullScreen() != gameSettings.fullScreen) {
                            toggleFullscreen();
                        }

...
public class GuiNewChat extends Gui {
    ...
    public IChatComponent getChatComponent(final int p_146236_1_, final int p_146236_2_) {
        ...
        if (j <= MathHelper.floor_float(this.getChatWidth() / this.getChatScale()) && k < font.FONT_HEIGHT * l + l) {
            final int i2 = k / font.FONT_HEIGHT + this.scrollPos;

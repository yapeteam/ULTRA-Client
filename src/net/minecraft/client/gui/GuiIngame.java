...
import cn.timer.ultra.module.modules.render.Crosshair;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (this.showCrosshair() && !Client.instance.getModuleManager().getByClass(Crosshair.class).isEnabled()) {
        ...
        EventRenderShadow e = new EventRenderShadow(partialTicks);
        EventManager.instance.call(e);
        shadowFramebuffer.unbindFramebuffer();
        ShadowUtils.renderShadow(shadowFramebuffer.framebufferTexture, 8, 2, e.getColor());

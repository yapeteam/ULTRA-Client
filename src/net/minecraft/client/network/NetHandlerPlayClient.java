...
import cn.timer.ultra.module.modules.cheat.LunarSpoof;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        if (Client.instance.getModuleManager().getByClass(LunarSpoof.class).isEnabled()) {
            this.netManager.sendPacket(new C17PacketCustomPayload("REGISTER", (new PacketBuffer(Unpooled.buffer())).writeString("Lunar-Client")));
            this.netManager.sendPacket(new C17PacketCustomPayload("Lunar-Client", (new PacketBuffer(Unpooled.buffer())).writeBytesP(createPacket26())));
        }
    }
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        ...
        if (!e.isCancelled()) this.netManager.sendPacket(p_147297_1_);
    }
    ...
    public void handleExplosion(S27PacketExplosion packetIn) {
        ...
        EventPacket eventPacket = new EventPacket(packet, Event.Type.Receive);
        EventManager.instance.call(eventPacket);

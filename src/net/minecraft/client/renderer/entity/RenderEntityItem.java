...
import cn.timer.ultra.module.modules.render.ItemPhysic;
import cn.timer.ultra.utils.ultra.render.ClientPhysic;
...
public class RenderEntityItem extends Render<EntityItem> {
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (Client.instance.getModuleManager().getByClass(ItemPhysic.class).isEnabled()) {

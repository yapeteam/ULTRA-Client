...
public class ItemRenderer {
     ...
     */
    private void doBlockTransformations(float process) {
        GlStateManager.translate(-0.5F, 0.2F, 0.0F);
        GlStateManager.rotate(-process * 30.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(process * -100.0F, 1.0F, 0.0F, -process);
        GlStateManager.rotate(-process * -80.0F, 0.0F, 1.0F, 0.0F);
    }
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            final float funny = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927f);
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            this.transformFirstPersonItem(f, 0.0F);
                            this.doBlockTransformations(funny);
                            break;

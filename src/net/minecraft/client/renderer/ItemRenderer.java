...
import cn.timer.ultra.module.modules.render.Animations;
...
public class ItemRenderer {
    ...
    private void performDrinking(AbstractClientPlayer clientPlayer, float partialTicks) {
        ...
        GlStateManager.rotate(f3 * 50.0F, 0.0F, 2.0F, f3);
        GlStateManager.rotate(f3 * 40.0F, 1.0F, 2.0F, f3 * 2f);
        GlStateManager.rotate(f3 * 10.0F, 0.0F, -1.0F, 1.0F);
    }
    ...
    private void doItemRenderGLTranslate() {
        GlStateManager.translate(animations.getItemPosXValue().floatValue(), animations.getItemPosYValue().floatValue(), animations.getItemPosZValue().floatValue());
    }

    private void doItemRenderGLScale() {
        GlStateManager.scale(animations.getItemScaleValue().floatValue(), animations.getItemScaleValue().floatValue(), animations.getItemScaleValue().floatValue());
    }
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (animations == null) {
            animations = Client.instance.getModuleManager().getByClass(Animations.class);
        }
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            GL11.glTranslated(animations.getTranslateXValue().floatValue(), animations.getTranslateYValue().floatValue(), animations.getTranslateZValue().floatValue());
                            GlStateManager.rotate(animations.getRotateXValue().floatValue(), 1.0F, 0.0F, 0.0F);
                            GlStateManager.rotate(animations.getRotateYValue().floatValue(), 0.0F, 1.0F, 0.0F);
                            GlStateManager.rotate(animations.getRotateZValue().floatValue(), 0.0F, 1.0F, 0.0F);
                            switch (animations.getBlockingModeValue().getValue()) {
                                case "1.7": {

...
public class ResourceLocation {
    ...
    public ResourceLocation(String resourceDomainIn, String resourcePathIn) {
        this.resourceDomain = org.apache.commons.lang3.StringUtils.isEmpty(resourceDomainIn) ? "minecraft" : resourceDomainIn.toLowerCase();
        this.resourcePath = resourcePathIn;
        Validate.notNull(this.resourcePath);
    }

    public ResourceLocation(String resourceName) {
        this(splitObjectName(resourceName)[0], splitObjectName(resourceName)[1]);
    }

...
import cn.timer.ultra.module.modules.render.waveyCapes.CapeHolder;
import cn.timer.ultra.module.modules.render.waveyCapes.StickSimulation;
...
public abstract class EntityPlayer extends EntityLivingBase implements CapeHolder {
    ...
    public boolean isInvisibleToPlayer(EntityPlayer player) {
        if (Client.instance.getModuleManager().getByClass(AntiInvisible.class).isEnabled()) {
            return false;
        }
        if (!this.isInvisible()) {
            return false;

...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_) {
        ...
        EventPacket eventPacket = new EventPacket(p_channelRead0_2_, Event.Type.Receive);
        EventManager.instance.call(eventPacket);
        if (this.channel.isOpen() && !e.isCancelled() && !eventPacket.isCancelled()) {
            try {
    ...
    public void sendPacket(Packet packetIn) {
        EventPacket eventPacket = new EventPacket(packetIn, Event.Type.Send);
        EventManager.instance.call(eventPacket);

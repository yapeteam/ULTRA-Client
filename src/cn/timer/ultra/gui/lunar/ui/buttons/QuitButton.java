...
public class QuitButton extends ImageButton {
    ...
    protected void drawHoverEffect() {
        ...
        ClientGuiUtils.drawRoundedRect(this.x + (this.width - w / 0.9f) / 2, this.y + 17, w / 0.9f, 7, 2, new Color(0, 0, 0, 126));
        FontUtil.TEXT_BOLD.getFont().drawString(this.text, this.x + (this.width - FontUtil.TEXT_BOLD.getFont().getStringWidth(text)) / 2, (this.y + 17 - (this.height - FontUtil.TEXT_BOLD.getFont().getHeight()) / 2), new Color(255, 255, 255, 135).getRGB());
    }

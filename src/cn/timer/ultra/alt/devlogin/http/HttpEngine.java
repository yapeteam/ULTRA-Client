package cn.timer.ultra.alt.devlogin.http;

import cn.timer.ultra.alt.devlogin.http.apache.ApacheHttpEngine;
...
public abstract class HttpEngine {
    ...
    private static HttpEngine tryLoad() {
        return new ApacheHttpEngine();
    }
}

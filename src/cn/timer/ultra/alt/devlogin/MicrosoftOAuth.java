...
import cn.timer.ultra.alt.devlogin.data.*;
...
import static cn.timer.ultra.alt.devlogin.util.ColUtils.mapOf;
...
public class MicrosoftOAuth {
    ...
    /**
     * Azure application client ID. Must have 'No keyboard (Device Code Flow)' 身份验证 -> '无键盘(设备代码流)' enabled.
     */
    public static final String CLIENT_ID = Client.CLIENT_ID;//Ultra-Client OAuth

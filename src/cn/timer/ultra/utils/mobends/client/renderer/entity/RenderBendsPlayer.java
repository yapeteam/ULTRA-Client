package cn.timer.ultra.utils.mobends.client.renderer.entity;

import cn.timer.ultra.Client;
import cn.timer.ultra.module.modules.player.MoBendsMod;
import cn.timer.ultra.module.modules.render.waveyCapes.CustomCapeRenderLayer;
import cn.timer.ultra.utils.mobends.client.model.entity.ModelBendsPlayer;
import cn.timer.ultra.utils.mobends.client.renderer.entity.layers.LayerBendsCape;
import cn.timer.ultra.utils.mobends.client.renderer.entity.layers.LayerBendsCustomHead;
import cn.timer.ultra.utils.mobends.client.renderer.entity.layers.LayerBendsPlayerArmor;
...
public class RenderBendsPlayer extends RenderPlayer {
    ...
    protected void preRenderCallback(AbstractClientPlayer clientPlayer, float partialTicks) {
        ...
        if (Client.instance.getModuleManager().getByClass(MoBendsMod.class).swordTrail.getValue()) {
            GL11.glPushMatrix();
            float f5 = 0.0625F;

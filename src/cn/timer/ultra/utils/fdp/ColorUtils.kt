...
object ColorUtils {
    ...
    const val rainbowStartValue = 0.41f
    const val rainbowStopValue = 0.58f
    private const val rainbowSaturationValue = 0.7f
    private const val rainbowBrightnessValue = 1f
    private const val rainbowSpeedValue = 1500

    fun hslRainbow(
        index: Int,
        lowest: Float = rainbowStartValue,
        bigest: Float = rainbowStopValue,
        indexOffset: Int = 300,
        timeSplit: Int = rainbowSpeedValue,
        saturation: Float = rainbowSaturationValue,
        brightness: Float = rainbowBrightnessValue
    ): Color {

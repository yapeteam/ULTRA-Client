...
import cn.timer.ultra.event.events.EventStrafe
...
data class Rotation(var yaw: Float, var pitch: Float) {
    ...
    fun toPlayer(player: EntityPlayer) {
        if ((yaw.isNaN() || pitch.isNaN()) && Client.instance.moduleManager.getByClass(Rotations::class.java).nanValue.getValue()) {
            return
        }
    ...
    fun fixedSensitivity(sensitivity: Float) {
        if (Client.instance.moduleManager.getByClass(Rotations::class.java).fixedValue.getValue() == "None") return
        if (Client.instance.moduleManager.getByClass(Rotations::class.java).fixedValue.getValue() == "Old") {
        ...
        val rotation = Client.rotationUtils.serverRotation
